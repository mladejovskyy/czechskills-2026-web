...
import { getFaqCategoryBySlug } from "@/actions/faq";
...
export default async function FaqCategoryPage({
  ...
  const category = await getFaqCategoryBySlug(tenant.id, categorySlug);
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <CreateItemDialog tenantId={tenant.id} categoryId={category.id} />
      </div>
